...
use VicGutt\ComponentBackport\View\Compilers\ComponentTagCompiler;
use VicGutt\ComponentBackport\View\Component;
...
class BladeComponentTagCompilerTest extends AbstractBladeTestCase
{
    ...
    public function testBasicComponentParsing()
    {
        ...
        $this->assertSame("<div> @component('VicGutt\ComponentBackport\Tests\View\Blade\TestAlertComponent', 'alert', [])
<?php \$component->withAttributes(['type' => 'foo','limit' => '5','@click' => 'foo','wire:click' => 'changePlan(\''.e(\$plan).'\')','required' => true]); ?>\n".
"@endcomponentClass  @component('VicGutt\ComponentBackport\Tests\View\Blade\TestAlertComponent', 'alert', [])
...
'@endcomponentClass </div>', trim($result));
    ...
    public function testDataCamelCasing()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\Tests\View\Blade\TestProfileComponent', 'profile', ['userId' => '1'])
...
<?php \$component->withAttributes([]); ?> @endcomponentClass", trim($result));
    ...
    public function testColonAttributesIsEscapedIfStrings()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\Tests\View\Blade\TestProfileComponent', 'profile', [])
<?php \$component->withAttributes(['src' => \VicGutt\ComponentBackport\View\Compilers\BladeCompiler::sanitizeComponentAttribute('foo')]); ?> @endcomponentClass", trim($result));
    }
    ...
    public function testColonNestedComponentParsing()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\Tests\View\Blade\TestAlertComponent', 'foo:alert', [])
<?php \$component->withAttributes([]); ?> @endcomponentClass", trim($result));
    }
...
'@endcomponentClass </div>', trim($result));
    ...
    public function testComponentsCanBeCompiledWithHyphenAttributes()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\Tests\View\Blade\TestAlertComponent', 'alert', [])
...
'@endcomponentClass', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithDataAndAttributes()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => 'foo'])
...
'@endcomponentClass', trim($result));
    ...
    public function testComponentCanReceiveAttributeBag()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\Tests\View\Blade\TestProfileComponent', 'profile', [])
<?php \$component->withAttributes(['class' => 'bar','attributes' => \VicGutt\ComponentBackport\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$attributes),'wire:model' => 'foo']); ?> @endcomponentClass", trim($result));
    }
    ...
    public function testSelfClosingComponentCanReceiveAttributeBag()
    {
        ...
        $this->assertSame("<div> @component('VicGutt\ComponentBackport\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => 'foo'])
<?php \$component->withAttributes(['class' => 'bar','attributes' => \VicGutt\ComponentBackport\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\$attributes->merge(['class' => 'test'])),'wire:model' => 'foo']); ?>\n".
            '@endcomponentClass </div>', trim($result));
    }
...
'@endcomponentClass Words', trim($result));
    ...
    public function testSelfClosingComponentsCanBeCompiledWithBoundData()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\Tests\View\Blade\TestAlertComponent', 'alert', ['title' => \$title])
...
<?php \$component->withAttributes([]); ?>
 @endcomponentClass", trim($result));
    ...
    public function testClasslessComponents()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\View\AnonymousComponent', 'anonymous-component', ['view' => 'components.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php \$component->withAttributes(['name' => \VicGutt\ComponentBackport\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endcomponentClass', trim($result));
    }
    ...
    public function testPackagesClasslessComponents()
    {
        ...
        $this->assertSame("@component('VicGutt\ComponentBackport\View\AnonymousComponent', 'package::anonymous-component', ['view' => 'package::components.anonymous-component','data' => ['name' => 'Taylor','age' => 31,'wire:model' => 'foo']])
<?php \$component->withAttributes(['name' => \VicGutt\ComponentBackport\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Taylor'),'age' => 31,'wire:model' => 'foo']); ?>\n".
'@endcomponentClass', trim($result));
    }
