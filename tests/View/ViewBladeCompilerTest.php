...
class ViewBladeCompilerTest extends TestCase
{
    ...
    public function testComponentAliasesCanBeConventionallyDetermined()
    {
        ...
        $compiler->component('VicGutt\ComponentBackport\View\Components\Forms\Input');
        $this->assertEquals(['forms:input' => 'VicGutt\ComponentBackport\View\Components\Forms\Input'], $compiler->getClassComponentAliases());

        $compiler = new BladeCompiler($files = $this->getFiles(), __DIR__);

        $compiler->component('VicGutt\ComponentBackport\View\Components\Forms\Input', null, 'prefix');
        $this->assertEquals(['prefix-forms:input' => 'VicGutt\ComponentBackport\View\Components\Forms\Input'], $compiler->getClassComponentAliases());
    }
