...
namespace VicGutt\ComponentBackport\View\Compilers;
...
use VicGutt\ComponentBackport\View\AnonymousComponent;
use VicGutt\ComponentBackport\View\DynamicComponent;
use VicGutt\ComponentBackport\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @param  array  $aliases
     * @param  \VicGutt\ComponentBackport\View\Compilers\BladeCompiler|null
     * @return void
     */
        ...
        return collect($attributes)
                ->map(function (string $value, string $attribute) use ($escapeBound) {
                    return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                                ? "'{$attribute}' => \VicGutt\ComponentBackport\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                                : "'{$attribute}' => {$value}";
                })
                ->implode(',');
    }
